...
<table id="Table1" border="0" cellpadding="0" cellspacing="0" width="200">
	<tbody><tr>
	<td bgcolor="#15873c" nowrap="nowrap" height="20" valign="middle" width="21"><img src="files/icons_login.gif" height="17" hspace="1" vspace="1" width="20"></td>
	<td class="BlockHeaderLeftRight" height="20" width="178">&nbsp;<span id="IndicesLbl">Узлы учета</span></td>
	<td class="vdots" width="1"></td></tr>
	<tr style="font-family: Verdana; font-size: xx-small; color: #15873c"><td colspan=3 style="padding-left:5px"><a href="index.php?sel=register">Все узлы</a></td></tr>
	...
	<?php
	 ...
	 while ($ui)
		{	 
		 print '<tr style="font-family: Verdana; font-size: xx-small; color: #15873c"><td colspan=3 style="padding-left:5px"><a href="index.php?sel=register&id='.$ui[0].'" onmouseover="arrowOn(this);" onmouseout="arrowOff(this);">'.$ui[1].'</a></td></tr>
			<tr><td colspan="3" style="height:5px"></td></tr>';
...
<tbody><tr style="font-family: Verdana; font-size: 12px; background-color: #15873c; color:#ffffff; font-weight:bold"><td align="center">Журнал аварий и событий</td></tr>
<tr><td>
<table border="0" cellpadding="1" cellspacing="1" width="1050" bgcolor="#15873c">
<tbody><tr>
<td>
<?php
 ...
 while ($ui)
	{	 
	 ...
	 print '<td class="BlockHeaderLeftRight" align="center">'.$ui[3].'</td>';
      	 print '<td style="padding-left:2px; padding-right:2px">'.$dev.' ['.$ui[1].']</td>';
      	 print '<td style="padding-left:2px; padding-right:2px">'.$chan.'</td>';
      	 if ($ui[6]=='1') print '<td style="padding-left:2px; padding-right:2px; background-color:#aaeeaa">информация</td>';
      	 if ($ui[6]=='2') print '<td style="padding-left:2px; padding-right:2px; background-color:#33dddd; align:center">предупреждение</td>';
      	 if ($ui[6]=='3' || $ui[2]=='0') print '<td style="padding-left:2px; padding-right:2px; background-color:#aa0000; align:center">ошибка</td>';
