...
if ($_GET["type"]) $type=$_GET["type"];
     if ($_GET["prm"]=='1')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=4 AND value<110 AND source=0 AND device='.$_GET["device"].' ORDER BY date DESC';
     ...
     if ($_GET["prm"]=='2')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=4 AND value<110 AND source=1 AND device='.$_GET["device"].' ORDER BY date DESC';
	  //echo $query;
     ...
     if ($_GET["prm"]=='3')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=12 AND value<80 AND source=6 AND device='.$_GET["device"].' ORDER BY date DESC';
	  $a = mysql_query ($query,$i);
	  if ($a) $uy = mysql_fetch_row ($a);
	  while ($uy)
		{
     ...
     if ($_GET["prm"]=='4')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=12 AND value<80 AND source=5 AND device='.$_GET["device"].' ORDER BY date DESC';
	  $a = mysql_query ($query,$i); $rr=0;
	  if ($a) $uy = mysql_fetch_row ($a);
	  while ($uy)
		{
     ...
     if ($_GET["prm"]=='5')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=11 AND source=0 AND device='.$_GET["device"].' ORDER BY date DESC';
	  $a = mysql_query ($query,$i);
	  if ($a) $uy = mysql_fetch_row ($a);
	  while ($uy)
		{
     ...
     if ($_GET["prm"]=='6')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=11 AND source=1 AND device='.$_GET["device"].' ORDER BY date DESC';
	  $a = mysql_query ($query,$i); $rr=0;
	  if ($a) $uy = mysql_fetch_row ($a);
	  while ($uy)
		{
     ...
     if ($_GET["prm"]=='7')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=13 AND source=10 AND device='.$_GET["device"].' ORDER BY date DESC';
	  $a = mysql_query ($query,$i);
	  if ($a) $uy = mysql_fetch_row ($a);
	  while ($uy)
		{
     ...
     if ($_GET["prm"]=='8')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=13 AND source=11 AND device='.$_GET["device"].' ORDER BY date DESC';
	  $a = mysql_query ($query,$i);
	  if ($a) $uy = mysql_fetch_row ($a);
	  while ($uy)
		{
     ...
     if ($_GET["prm"]=='9')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=13 AND source=2 AND device='.$_GET["device"].' ORDER BY date DESC';
	  $a = mysql_query ($query,$i); $rr=0;
	  if ($a) $uy = mysql_fetch_row ($a);
	  while ($uy)
		{
     ...
     if ($_GET["prm"]=='10')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=12 AND source=6 AND device='.$_GET["device"].' ORDER BY date DESC';
	  $a = mysql_query ($query,$i);
	  if ($a) $uy = mysql_fetch_row ($a);
	  while ($uy)
		{
     ...
     if ($_GET["prm"]=='11')
	{
	  $query = 'SELECT * FROM data WHERE type='.$type.' AND prm=12 AND source=5 AND device='.$_GET["device"].' ORDER BY date DESC';
	  $a = mysql_query ($query,$i); $rr=0;
	  if ($a) $uy = mysql_fetch_row ($a);
	  while ($uy)
		{
